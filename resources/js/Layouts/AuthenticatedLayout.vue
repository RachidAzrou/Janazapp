...
// Sample command items (you can replace this with your actual logic)
const commandItems = [
  "profile",
  "users",
  "settings"
...
// Filter command items based on inputValue
...
// Handle input change
const handleInput = () => {
  console.log('Input value:', inputValue.value); // Log input for debugging
};
      ...
      <nav class="bg-white border-b border-gray-100">
          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <NavLink :href="route('cases')" :active="route().current('cases')">
                  Cases
                </NavLink>
              </div>
            </div>
        ...
        >
          <div class="pt-2 pb-3 space-y-1">
            ...
            <ResponsiveNavLink :href="route('cases')" :active="route().current('cases')">
              Cases
            </ResponsiveNavLink>
          </div>
